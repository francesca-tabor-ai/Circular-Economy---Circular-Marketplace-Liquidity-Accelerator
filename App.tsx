...
const App: React.FC = () => {
  ...
  const renderDashboard = () => (
    <div className="space-y-10 animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div>
          <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight">Marketplace Health</h1>
        ...
        <div className="flex items-center gap-3">
          <div className="bg-emerald-50 text-emerald-700 border border-emerald-100 px-5 py-2.5 rounded-2xl flex items-center gap-3 shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        <div className="lg:col-span-2 bg-white border border-slate-200 p-8 rounded-3xl shadow-sm">
          <div className="flex justify-between items-center mb-4">
            <div>
              <h3 className="text-xl font-extrabold text-slate-900">Transaction Velocity</h3>
              <p className="text-slate-400 text-sm font-medium mt-1">Growth rate of cleared trades per week</p>
            </div>
          </div>
          <LiquidityChart />
        </div>
        
        <div className="bg-slate-900 text-white p-8 rounded-3xl flex flex-col shadow-xl ring-1 ring-slate-800">
          <div className="flex justify-between items-center mb-8">
            <div>
              <h3 className="text-xl font-bold">AI Strategist</h3>
              <p className="text-slate-500 text-xs font-medium uppercase tracking-widest mt-1">Liquidity Guard</p>
            </div>
            <button 
  ...
  const renderVisuals = () => (
    <div className="space-y-10 animate-in slide-in-from-right-8 duration-700">
      <div className="border-b border-slate-200 pb-8">
        <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight">Visual Lab</h1>
        <p className="text-slate-500 mt-2 text-lg font-medium">Generate high-fidelity assets to seed demand and build brand authority.</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white border border-slate-200 p-8 rounded-3xl shadow-sm">
            <h3 className="text-xl font-bold text-slate-900 mb-6">Asset Brief</h3>
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <textarea 
                  rows={4}
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-medium focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none transition-all"
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest">Aspect Ratio</label>
              ...
              <button 
                ...
                className="w-full py-4 bg-slate-900 text-white rounded-2xl font-bold text-sm shadow-xl shadow-slate-200 hover:bg-slate-800 disabled:opacity-50 transition-all uppercase tracking-widest"
              >
          ...
          <div className="bg-emerald-900 text-emerald-50 p-6 rounded-3xl">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {isGeneratingImage && (
              <div className={`bg-slate-100 rounded-3xl animate-pulse flex items-center justify-center ${
            ...
            {generatedAssets.map(asset => (
              <div key={asset.id} className="group relative bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
                ...
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-end p-6">
                   ...
                   <div className="flex gap-2">
                     <a href={asset.url} download={`cmla-asset-${asset.id}.png`} className="flex-1 py-2 bg-white text-slate-900 rounded-xl text-[10px] font-bold text-center uppercase tracking-widest hover:bg-emerald-400 hover:text-white transition-colors">
                       Download
                     </a>
            ...
            {generatedAssets.length === 0 && !isGeneratingImage && (
              <div className="col-span-2 py-32 flex flex-col items-center justify-center text-slate-300 border-2 border-dashed border-slate-200 rounded-3xl">
  ...
  const renderSupply = () => (
    <div className="space-y-10 animate-in slide-in-from-bottom-8 duration-700">
      <div className="flex justify-between items-end border-b border-slate-200 pb-8">
        <div>
          <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight">Supply Engine</h1>
          <p className="text-slate-500 mt-2 text-lg font-medium">Capture early suppliers to build a defensive moat.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white border border-slate-200 p-8 rounded-2xl shadow-sm">
          <p className="text-slate-400 text-[11px] uppercase font-extrabold tracking-widest mb-4">Concentration Risk</p>
          <div className="flex items-center gap-4">
            <div className="flex-1 h-3 bg-slate-100 rounded-full overflow-hidden">
              <div className="h-full bg-rose-500" style={{ width: '75%' }}></div>
            </div>
            <span className="text-lg font-extrabold text-slate-900">75%</span>
          </div>
        ...
        <div className="bg-white border border-slate-200 p-8 rounded-2xl shadow-sm">
          <p className="text-slate-400 text-[11px] uppercase font-extrabold tracking-widest mb-2">Incentive ROI</p>
          <p className="text-4xl font-extrabold text-slate-900 tracking-tighter">4.2<span className="text-xl text-slate-400 ml-1">x</span></p>
          <p className="text-emerald-500 text-[10px] font-bold mt-1 tracking-tight">Efficient burn-to-liquidity ratio</p>
        </div>
        <div className="bg-white border border-slate-200 p-8 rounded-2xl shadow-sm">
          <p className="text-slate-400 text-[11px] uppercase font-extrabold tracking-widest mb-2">Avg Lock-In Score</p>
          <p className="text-4xl font-extrabold text-slate-900 tracking-tighter">62<span className="text-slate-300">/100</span></p>
        </div>
      </div>
      ...
      <div className="bg-white border border-slate-200 rounded-3xl shadow-sm overflow-hidden">
        <table className="w-full text-left">
          <thead className="bg-slate-50/50 border-b border-slate-100">
            <tr>
              <th className="px-8 py-5 text-[10px] font-extrabold uppercase text-slate-400 tracking-widest">Partner</th>
              <th className="px-8 py-5 text-[10px] font-extrabold uppercase text-slate-400 tracking-widest">Status</th>
              <th className="px-8 py-5 text-[10px] font-extrabold uppercase text-slate-400 tracking-widest">Wkly Volume</th>
              <th className="px-8 py-5 text-[10px] font-extrabold uppercase text-slate-400 tracking-widest">Lock-In Score</th>
          ...
          <tbody className="divide-y divide-slate-50">
            {suppliers.map(s => (
              <tr key={s.id} className="hover:bg-slate-50/30 transition-colors group">
                ...
                <td className="px-8 py-6">
                  <div className="flex items-center gap-3">
                    <div className="flex-1 h-2 bg-slate-100 rounded-full w-28 overflow-hidden">
                    ...
                    <span className="text-xs font-bold text-slate-900">{s.lockInScore}</span>
                  </div>
                </td>
                <td className="px-8 py-6 text-right opacity-0 group-hover:opacity-100 transition-opacity">
                  <button className="text-slate-400 hover:text-slate-900"><i className="fas fa-arrow-right"></i></button>
                </td>
              </tr>
            ))}
          </tbody>
  ...
  const renderDemand = () => (
    <div className="space-y-10 animate-in slide-in-from-top-8 duration-700">
      <div className="flex justify-between items-end border-b border-slate-200 pb-8">
        <div>
          <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight">Demand Seeding</h1>
          <p className="text-slate-500 mt-2 text-lg font-medium">Build a deep pipeline of high-intent circular off-takers.</p>
        </div>
        <div className="flex gap-4">
          <button className="bg-white border border-slate-200 text-slate-900 px-6 py-3 rounded-xl font-bold text-sm hover:bg-slate-50 transition-colors">
            SEGMENT ANALYSIS
          </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm">
          <p className="text-slate-400 text-[10px] uppercase font-black tracking-widest mb-1">Pipeline Depth</p>
        ...
        <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm">
          <p className="text-slate-400 text-[10px] uppercase font-black tracking-widest mb-1">Demand Coverage</p>
          <p className="text-2xl font-black text-slate-950">1.4x <span className="text-sm text-slate-400 font-bold">Supply</span></p>
          <p className="text-blue-500 text-[10px] font-bold mt-1 tracking-tight">Healthy overflow</p>
        </div>
        <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm">
          <p className="text-slate-400 text-[10px] uppercase font-black tracking-widest mb-1">Avg Qualification</p>
          <p className="text-2xl font-black text-slate-950">68%</p>
          <p className="text-slate-400 text-[10px] font-bold mt-1 tracking-tight">Ready for trade</p>
        </div>
        <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm">
          <p className="text-slate-400 text-[10px] uppercase font-black tracking-widest mb-1">Conversion Velocity</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 bg-white border border-slate-200 rounded-3xl shadow-sm overflow-hidden">
          <div className="px-8 py-6 border-b border-slate-100 flex justify-between items-center">
            <h3 className="font-black text-slate-900 text-lg uppercase tracking-tight">Lead Pipeline</h3>
            <div className="flex gap-2">
              <span className="px-2 py-1 bg-slate-100 rounded-md text-[9px] font-black text-slate-500 uppercase tracking-widest">Filter: All</span>
            </div>
          </div>
          <table className="w-full text-left">
            <thead>
              <tr className="bg-slate-50/50">
                <th className="px-8 py-4 text-[9px] font-black uppercase text-slate-400 tracking-widest">Buyer</th>
                <th className="px-8 py-4 text-[9px] font-black uppercase text-slate-400 tracking-widest">Segment</th>
                <th className="px-8 py-4 text-[9px] font-black uppercase text-slate-400 tracking-widest">Status</th>
                <th className="px-8 py-4 text-[9px] font-black uppercase text-slate-400 tracking-widest">Qual Score</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-50">
              {buyers.map(b => (
                <tr key={b.id} className="hover:bg-slate-50/30 transition-colors cursor-pointer">
                  ...
                  <td className="px-8 py-5">
                    <p className="text-xs font-bold text-slate-500">{b.acquisitionStatus}</p>
                  </td>
                  <td className="px-8 py-5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-black text-slate-900">{b.qualificationScore}%</span>
                    </div>
                  </td>
                </tr>
              ))}
        ...
        <div className="bg-indigo-900 text-white p-8 rounded-3xl shadow-xl flex flex-col">
          ...
          <div className="space-y-4 mb-8">
            <button 
              ...
              className="w-full text-left p-4 bg-indigo-800/50 hover:bg-indigo-800 border border-indigo-700/50 rounded-2xl transition-all group"
            >
  ...
  const renderAILab = () => (
    <div className="space-y-10 animate-in zoom-in-95 duration-500">
       <div className="border-b border-slate-200 pb-8">
        <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight">Playbook Lab</h1>
        <p className="text-slate-500 mt-2 text-lg font-medium">Turn tactics into repeatable AI-driven growth workflows.</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        <div className="bg-white border border-slate-200 p-8 rounded-3xl shadow-sm space-y-8">
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-slate-900">Sequence Generator</h3>
            <p className="text-sm text-slate-500 font-medium">Generate category-leadership focused outbound copy.</p>
          </div>
          
          <div className="space-y-6">
            <div className="p-1 bg-slate-100 rounded-xl flex">
              <button className="flex-1 py-2 rounded-lg bg-white shadow-sm text-slate-900 text-xs font-bold transition-all">SUPPLIERS</button>
              <button className="flex-1 py-2 rounded-lg text-slate-500 text-xs font-bold hover:text-slate-900 transition-all">BUYERS</button>
            </div>
            
            <div className="space-y-2">
              <label className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest">Vertical Category</label>
              <input 
                className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-sm font-medium focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none transition-all shadow-sm" 
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest">Core Value Prop</label>
              <textarea 
                rows={4}
                className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-sm font-medium focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none transition-all shadow-sm"
            ...
            <button 
              ...
              className="stripe-gradient w-full py-4 text-white rounded-2xl font-bold text-sm shadow-lg shadow-emerald-500/10 hover:opacity-90 disabled:opacity-50 transition-all uppercase tracking-widest"
            >
        ...
        <div className="bg-slate-50 border-2 border-dashed border-slate-200 p-8 rounded-3xl relative min-h-[500px] overflow-hidden">
          <div className="absolute top-8 right-8">
            <button className="bg-white border border-slate-200 w-10 h-10 rounded-xl shadow-sm text-slate-400 hover:text-slate-900 transition-colors flex items-center justify-center">
  ...
  const renderLanding = () => (
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-6xl mx-auto px-6 lg:px-10 py-20 lg:py-32">
        <div className="text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6">
            <button
              onClick={() => setCurrentView('Dashboard')}
              className="stripe-gradient px-8 py-4 rounded-2xl text-white font-bold text-base shadow-xl shadow-emerald-500/20 hover:opacity-90 transition-all uppercase tracking-widest"
            >
              Start Your Liquidity Sprint
            </button>
            <button
              onClick={() => setIsChatOpen(true)}
              className="bg-white border-2 border-slate-900 px-8 py-4 rounded-2xl text-slate-900 font-bold text-base hover:bg-slate-50 transition-all uppercase tracking-widest"
            >
      ...
      <section className="bg-slate-50 border-y border-slate-200 py-8">
        <div className="max-w-6xl mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
            <div className="space-y-2">
              <i className="fas fa-puzzle-piece text-2xl text-slate-400"></i>
            ...
            <div className="space-y-2">
              <i className="fas fa-network-wired text-2xl text-slate-400"></i>
              <p className="text-sm font-bold text-slate-700">Network effects lock markets</p>
            </div>
            <div className="space-y-2">
              <i className="fas fa-bolt text-2xl text-slate-400"></i>
      ...
      <section className="max-w-4xl mx-auto px-6 lg:px-10 py-20">
        <div className="space-y-6">
          <h2 className="text-4xl font-extrabold text-slate-900 tracking-tight">THE PROBLEM</h2>
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-3xl p-8 space-y-4">
            ...
            <p className="pt-4 text-lg font-bold text-slate-900 border-t border-slate-200">
      ...
      <section className="bg-slate-900 text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-10 space-y-8">
          <h2 className="text-4xl font-extrabold tracking-tight">THE SOLUTION</h2>
          ...
          <div className="bg-slate-800/50 border border-slate-700 rounded-3xl p-8 space-y-4">
      ...
      <section className="max-w-6xl mx-auto px-6 lg:px-10 py-20">
        <h2 className="text-4xl font-extrabold text-slate-900 tracking-tight text-center mb-12">HOW IT WORKS</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm">
            <div className="w-12 h-12 bg-slate-900 rounded-xl flex items-center justify-center text-white font-bold text-xl mb-6">1</div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">Lock Supply Early</h3>
            <p className="text-slate-600 font-medium">Secure suppliers before competitors can access them.</p>
          </div>
          <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm">
            <div className="w-12 h-12 bg-slate-900 rounded-xl flex items-center justify-center text-white font-bold text-xl mb-6">2</div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">Seed Qualified Demand</h3>
            <p className="text-slate-600 font-medium">Bring in buyers that actually transact.</p>
          </div>
          <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm">
            <div className="w-12 h-12 bg-slate-900 rounded-xl flex items-center justify-center text-white font-bold text-xl mb-6">3</div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">Monitor Liquidity Health Live</h3>
            <p className="text-slate-600 font-medium">See transaction risk before it becomes failure.</p>
          </div>
          <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm">
            <div className="w-12 h-12 bg-slate-900 rounded-xl flex items-center justify-center text-white font-bold text-xl mb-6">4</div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">Execute Operator-Grade Playbooks</h3>
      ...
      <section className="bg-slate-50 border-y border-slate-200 py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-10 space-y-8">
          <h2 className="text-4xl font-extrabold text-slate-900 tracking-tight">FOUNDER AI SECTION</h2>
          <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-slate-900">Meet Alex Voss</h3>
                <p className="text-slate-600 font-medium">Founder. Systems Operator. Liquidity Strategist.</p>
              </div>
            </div>
            <div className="space-y-4">
              <p className="text-lg font-bold text-slate-900">Inside the platform, you get direct access to the Founder AI.</p>
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 mt-6">
                <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-3">Operator-level guidance on:</p>
      ...
      {/* Who This Is For */}
      <section className="max-w-4xl mx-auto px-6 lg:px-10 py-20">
        <h2 className="text-4xl font-extrabold text-slate-900 tracking-tight mb-8">WHO THIS IS FOR</h2>
        <div className="bg-emerald-50 border-2 border-emerald-200 rounded-3xl p-8">
          <h3 className="text-2xl font-bold text-slate-900 mb-6">Built For</h3>
      ...
      <section className="bg-slate-900 text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-10">
          <h2 className="text-4xl font-extrabold tracking-tight mb-8">CORE OUTCOMES</h2>
      ...
      <section className="max-w-4xl mx-auto px-6 lg:px-10 py-20">
        <h2 className="text-4xl font-extrabold text-slate-900 tracking-tight mb-8">DIFFERENT FROM EVERYTHING ELSE</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-rose-50 border-2 border-rose-200 rounded-3xl p-8">
            <h3 className="text-xl font-bold text-slate-900 mb-4">We are not:</h3>
            <ul className="space-y-2 text-slate-700">
              <li className="flex items-start gap-3">
          ...
          <div className="bg-emerald-50 border-2 border-emerald-200 rounded-3xl p-8">
            <h3 className="text-xl font-bold text-slate-900 mb-4">We are:</h3>
            <div className="bg-emerald-100 border border-emerald-300 rounded-2xl p-6">
      ...
      <section className="bg-slate-50 border-y border-slate-200 py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-10">
          <h2 className="text-4xl font-extrabold text-slate-900 tracking-tight mb-8">TRUST / CREDIBILITY</h2>
          <p className="text-lg font-bold text-slate-700 mb-6">Designed using principles from:</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white border border-slate-200 rounded-2xl p-6">
              <i className="fas fa-truck-fast text-2xl text-slate-400 mb-3"></i>
              <p className="font-bold text-slate-900">Mission-critical logistics environments</p>
            </div>
            <div className="bg-white border border-slate-200 rounded-2xl p-6">
              <i className="fas fa-triangle-exclamation text-2xl text-slate-400 mb-3"></i>
              <p className="font-bold text-slate-900">Disaster response systems</p>
            </div>
            <div className="bg-white border border-slate-200 rounded-2xl p-6">
              <i className="fas fa-trophy text-2xl text-slate-400 mb-3"></i>
              <p className="font-bold text-slate-900">Elite performance operations</p>
            </div>
            <div className="bg-white border border-slate-200 rounded-2xl p-6">
              <i className="fas fa-rocket text-2xl text-slate-400 mb-3"></i>
              <p className="font-bold text-slate-900">High-speed marketplace launches</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-900 text-white py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-10 text-center space-y-8">
          <h2 className="text-4xl lg:text-5xl font-extrabold tracking-tight">If You're Building a Circular Marketplace</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6">
            ...
            <button
              onClick={() => setIsChatOpen(true)}
              className="bg-white text-slate-900 border-2 border-white px-8 py-4 rounded-2xl font-bold text-base hover:bg-slate-100 transition-all uppercase tracking-widest"
            >
              Speak to Founder AI
            </button>
          </div>
      ...
      <>
        ...
        {isChatOpen && (
          <div className="fixed bottom-8 right-8 z-50 flex flex-col items-end">
            <div className="w-96 bg-white border border-slate-200 rounded-3xl shadow-2xl flex flex-col overflow-hidden mb-4 border-b-4 border-b-slate-900 animate-in slide-in-from-bottom-4 duration-300">
              <div className="p-4 bg-slate-900 text-white flex justify-between items-center">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-slate-200 rounded-xl flex items-center justify-center overflow-hidden border border-slate-700 shadow-inner">
                    <img src={FOUNDER_IMAGE_URL} className="w-full h-full object-cover" alt="Alex Voss" />
                  </div>
                  <div>
              ...
              <form onSubmit={handleSubmitMessage} className="p-4 bg-white border-t border-slate-100 flex gap-2">
                <input 
                  type="text"
                  placeholder="Ask Alex about constraints..."
                  className="flex-1 bg-slate-100 border-none rounded-xl px-4 py-3 text-sm focus:ring-1 focus:ring-slate-900 outline-none transition-all font-medium"
                  value={userInput}
        ...
        {!isChatOpen && (
          <div className="fixed bottom-8 right-8 z-50 flex flex-col items-end">
            <button 
              ...
              className="w-16 h-16 bg-white rounded-[2rem] shadow-2xl flex items-center justify-center hover:scale-110 transition-all group relative border-4 border-white overflow-hidden ring-1 ring-slate-200"
            >
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-slate-50 text-slate-900">
      ...
      <aside className="w-full md:w-72 bg-white border-r border-slate-200 flex flex-col z-20">
        <div className="p-8">
          <div className="flex items-center gap-3 mb-12">
            ...
            <div className="leading-none">
              ...
              <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Accelerator v2.0</span>
            </div>
          </div>
        ...
        <div className="mt-auto p-8">
          <div className="bg-slate-50 rounded-2xl p-5 border border-slate-100">
            <p className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-3">Liquidity Velocity</p>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]"></div>
              <p className="text-xs font-bold text-slate-900 tracking-tight">90-Day Sprint: Day 34</p>
            </div>
            <div className="w-full bg-slate-200 h-1.5 rounded-full overflow-hidden">
              <div className="bg-slate-900 h-full transition-all duration-1000" style={{ width: '38%' }}></div>
            </div>
          </div>
        </div>
      </aside>
      ...
      <main className="flex-1 flex flex-col h-screen overflow-y-auto relative">
        <header className="h-20 bg-white/70 backdrop-blur-xl border-b border-slate-200 flex items-center justify-between px-10 sticky top-0 z-30">
          <div className="flex items-center gap-2 text-xs font-bold text-slate-400 uppercase tracking-widest text-wrap">
            {currentView} <span className="text-slate-200 mx-2 text-lg">/</span> <span className="text-slate-900">Active Sprint</span>
          </div>
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3 cursor-pointer group">
              <span className="text-xs font-bold text-slate-900 group-hover:text-emerald-600 transition-colors">FOUNDER: J.D.</span>
              <div className="bg-slate-900 w-9 h-9 rounded-xl flex items-center justify-center text-xs font-bold text-white shadow-lg shadow-slate-200 overflow-hidden border border-slate-800">
        ...
        <div className="fixed bottom-8 right-8 z-50 flex flex-col items-end">
          ...
          >
             {isChatOpen ? (
               <i className="fas fa-times text-slate-900 text-xl"></i>
             ) : (
               <img src={FOUNDER_IMAGE_URL} className="w-full h-full object-cover rounded-[1.8rem]" alt="Founder Avatar" />
             )}
             {!isChatOpen && (
...
const SidebarItem: React.FC<SidebarItemProps> = ({ icon, label, active, onClick }) => (
  ...
  >
    <i className={`fas ${icon} w-5 text-base ${active ? 'text-emerald-400' : 'text-slate-300 group-hover:text-slate-500'}`}></i>
    {label}
  </button>
);
